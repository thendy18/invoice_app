...
@section('content')
    <div class="p-4">
        ...
        <table class="w-full table-auto border border-gray-300 mb-12">
            <thead class="bg-gray-200">
                <tr>
                    <th colspan="6" class="text-center text-lg font-semibold py-2 border">
                        Cotton Combed 30s
                    </th>
                </tr>
                <tr>
                    ...
                    <th class="border px-2 py-1">Panjang Baju</th>
                    <th class="border px-2 py-1">Lebar Baju</th>
                    <th class="border px-2 py-1">Panjang Lengan</th>
            ...
            <tbody>
                @forelse($products30s as $product)
                    <tr>
                        <td class="border px-2 py-1">{{ $product->ukuran }}</td>
                        <td class="border px-2 py-1">Rp{{ number_format($product->harga, 0, ',', '.') }}</td>
                        <td class="border px-2 py-1">{{ $product->panjang_baju }}</td>
                        <td class="border px-2 py-1">{{ $product->lebar_baju }}</td>
                        <td class="border px-2 py-1">{{ $product->panjang_lengan }}</td>
